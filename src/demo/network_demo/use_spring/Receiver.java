package demo.network_demo.use_spring;
...
public class Receiver {
    ...
    public static void main(String[] args) {
        ApplicationContext ctx = new FileSystemXmlApplicationContext("classpath:demo/network_demo/use_spring/applicationContext-*.xml");  
